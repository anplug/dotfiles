...
vicious.register(cpu_temp_widget, vicious.widgets.thermal, "CPU($1°C):", 2, "thermal_zone0")
...
client.connect_signal("mouse::enter", function(c)
    if awful.layout.get(c.screen) ~= l.magnifier
...
awful.util.spawn_with_shell("setxkbmap -layout ua,ua -option -variant lat, grp:alt_shift_toggle,caps:escape &")
awful.util.spawn_with_shell("xxkb &")
awful.util.spawn_with_shell("xbindkeys")
awful.util.spawn_with_shell("xset r rate 250 50")
awful.util.spawn_with_shell('xinput disable "Elan Touchpad"')
